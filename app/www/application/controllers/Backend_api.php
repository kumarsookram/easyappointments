...
class Backend_api extends EA_Controller {
    ...
    /**
     * Sends a reminder to all customers that have an appointment in a certain date
     */
    public function ajax_send_appointments_reminder()
    {
        try
        {
            $date = $this->input->post('date');
            ...
            foreach ($appointments as $index => $appointment)
            {
                ...
                $this->notifications->notify_appointment_reminder($appointment, $service, $provider, $customer, $settings);
            }

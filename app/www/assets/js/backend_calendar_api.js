...
(function (exports) {
    ...
    exports.sendAppointmentReminder = function (date, successCallback, errorCallback) {
        var url = GlobalVariables.baseUrl + '/index.php/backend_api/ajax_send_appointments_reminder';

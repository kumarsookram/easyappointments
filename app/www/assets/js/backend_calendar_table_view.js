...
(function (exports) {
    ...
    function bindEventHandlers() {
        ...
        $calendar.on('click', '.calendar-header .btn.select-today', function () {
    ...
    function createHeader() {
        ...
        $('<button/>', {
            'type': 'text',
            'class': 'ml-2 btn btn-xs btn-outline-secondary select-today',
            'html': [
                $('<span/>', {
                    'text': EALang.today
                })
    ...
    function createProviderColumn($dateColumn, date, provider, events) {
        ...
        var $providerColumn = $('<div/>', {
            'class': 'provider-column col-lg-2 col-md-4 col-sm-6 col-12 px-1'
        })
            .appendTo($dateColumn);

...
(function (exports) {
    ...
    exports.initialize = function (defaultEventHandlers) {
        ...
        GlobalVariables.settings.system.forEach(function (setting) {
            ...
            if (setting.name === 'provider_notifications') {
                $('#provider-notifications').prop('checked', Boolean(Number(setting.value)));
            }

            if (setting.name === 'secretary_notifications') {
                $('#secretary-notifications').prop('checked', Boolean(Number(setting.value)));
            }

            if (setting.name === 'admin_notifications') {
                $('#admin-notifications').prop('checked', Boolean(Number(setting.value)));
            }
        ...
        if (GlobalVariables.user.privileges.system_settings.edit === false) {
            $('#general, #website, #business-logic').find('select, input, textarea').prop('readonly', true);
            $('#general, #website, #business-logic').find('button').prop('disabled', true);
        }

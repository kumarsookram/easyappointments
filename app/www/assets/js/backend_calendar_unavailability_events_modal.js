...
(function (exports) {
    ...
    function bindEventHandlers() {
        ...
        $('#manage-unavailable #save-unavailable').on('click', function () {
            ...
            var provider_id = $('#unavailable-provider').val();
            ...
            if (provider_id == 0) {
                for (var index in GlobalVariables.availableProviders) {
                    ...
                    var unavailable = {
                        ...
                        id_users_provider: provider.id // curr provider
                    };
    ...
    exports.initialize = function () {
        ...
        $unavailabilityProvider.append(new Option(EALang.apply_to_all_providers, 0));
